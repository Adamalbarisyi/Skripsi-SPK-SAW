        ...
        <div class="modal-content">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo base_url() . 'admin/alternatif/edit/'. $id_proyek ?>" method="post"
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control input-bottom" name="lebar_depan_proyek"
                                            value="<?php echo $lebar_depan_proyek; ?>"
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control input-bottom" name="harga_total_proyek"
                                            value="<?php echo $harga_total_proyek; ?>"
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="status_post">
                                        <option value="">-PILIH-</option>
                                        <option <?php if ($status_post == '1') {
                                                            echo "selected";
                                                        } ?> value='1'>Iklan Aktif
                                        </option>

                                        <option <?php if ($status_post == '2') {
                                                            echo "selected";
                                                        } ?> value='2'>Iklan Sudah tidak aktif
                                        </option>
                                    </select>
                                </div>
                            </div>
