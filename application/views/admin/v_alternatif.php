            ...
            <div class="col-lg-12 col-sm-6">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Data Alternatif Aktif <span class="badge badge-success ml-2 p-2">Aktif</span> </h4>
                        <p class="text-muted m-b-30 font-14">
                            Data proyek tanah kavling publis yang ada di Yogyakarta
                        </p>

                        <div class="table-responsive">
                            <table id="" class="display table table-bordered dt-responsive  text-justify" style="width:100%">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td> <img class="img-fluid" style="width: 150px; height:150px" alt="100x100" src="<?php echo base_url() . 'uploads/produk/' . $fotoproyek1; ?>" query-holder-rendered="true">
                                    </td>
            ...
            <div class="modal-content">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?php echo base_url() . 'admin/alternatif/edit/'. $id_proyek ?>" method="post" enctype="multipart/form-data">

                            <input type="hidden" name="id_kriteria" value="<?php echo $id_proyek; ?>" />
                            <div class="form-group">
                                <label>Judul Proyek</label>
                                <input type="text" class="form-control input-bottom" name="judul_proyek" value="<?php echo $judul_proyek; ?>" placeholder="Tuliskan Judul Proyek" />
                            </div>

                            <div class="form-group">
                                <label>Deskripsi Proyek</label>
                                <div>
                                    <textarea id="elm1" name="deskripsi_proyek" cols=”45″ rows=”5″><?php echo $this->typography->auto_typography($deskripsi_proyek) ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-bottom" name="sertifikat_proyek" value="<?php echo $sertifikat_proyek; ?>" placeholder="Input Jenis Sertifikat" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-bottom" name="luastanah_proyek" value="<?php echo $luastanah_proyek; ?>" placeholder="Input Luas Tanah" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group mt-3">
                                        <label>Harga/m</label>
                                        <div>
                                            <input type="text" class="form-control input-bottom" name="harga/m_proyek" value="<?php echo $harga_m_proyek; ?>" placeholder="Input Harga/m" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-bottom" name="lebar_depan_proyek" value="<?php echo $lebar_depan_proyek; ?>" placeholder="Input Lebar Tanah" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-bottom" name="harga_total_proyek" value="<?php echo $harga_total_proyek; ?>" placeholder="Input Harga Total" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-bottom" name="jarak_proyek" value="<?php echo $jarak_proyek; ?>" placeholder="Input Jarak (Km)" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-bottom" name="nama_pengelola" value="<?php echo $nama_pengelola; ?>" placeholder="Input nama pengelola" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <div>
                                            <input type="number" class="form-control input-bottom" name="nomor_hp" value="<?php echo $nomor_hp; ?>" placeholder="Input No Hp/WA" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="form-group mt-2 mb-2">
                                        <label>Foto 4<small>* Foto Lokasi 1</small></label>
                                        <div class="custom-file">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group mt-2 mb-2">
                                        <label>Foto 5<small>* Foto lokasi 2</small></label>
                                        <div class="custom-file">
