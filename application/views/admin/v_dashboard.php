                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a
                                                href="<?php echo base_url() . 'admin/dashboard/verif_iklan/'.$id_proyek.'/'.'1'; ?>">
                                                <button type="button" name="status_post" value="1"
                                                    class="btn btn-success editable-submit btn-sm waves-effect waves-light"><i
                                                        class="mdi mdi-check"></i></button>
                                            </a>

                                            <a
                                                href="<?php echo base_url() . 'admin/dashboard/verif_iklan/'.$id_proyek.'/'.'2'; ?>">
                                                <button type="button" name="status_post" value="2"
        ...
        <div class="modal-content">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group text-center">
                        <h6 class="m-0"><?php echo $this->typography->auto_typography($judul_proyek);?></h6>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo base_url() . 'admin/dashboard/edit/'.$id_proyek ?>" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-bottom" name="judul_proyek"
                                value="<?php echo $this->typography->auto_typography($judul_proyek);?>" placeholder="Tuliskan Judul Proyek" />
                        </div>

                        <div class="form-group">
                            <label>Deskripsi Proyek</label>
                            <div>
                                <textarea id="elm1" name="deskripsi_proyek" cols=”1000″
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group mt-3">
                                    <img class="img-fluid" style="width: 150px; height:250px" alt="100x100"
                                        src="<?php echo base_url() . 'uploads/produk/' . $fotoproyek2; ?>"
                                        data-holder-rendered="true">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="form-group mt-2 mb-2">
                                    <label>Foto 4<small>* Foto Lokasi Proyek</small></label>
                                    <div class="custom-file">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="form-group mt-2 mb-2">
                                    <label>Foto 5<small>* Foto Lokasi Proyek</small></label>
                                    <div class="custom-file">
