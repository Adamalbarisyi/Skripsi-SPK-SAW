                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Hasil Perangkingan</a>
                            </li>
                                ...
                                <div class="p-4 float-right">
                                    <button type="button" class="btn btn-info waves-effect waves-light"
                                        data-toggle="modal" data-target="#myModal"><i
                                            class="mdi mdi-plus p-1 font-weight-bold"></i>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-warning" data-toggle="modal"
                                                    data-target="#myModal1"><i
                                                        class="mdi mdi-lead-pencil font-weight-bold"></i></button>
                                                ...
                                                <button type="button" class="btn btn-danger" id="sa-warning"><i
                                                        class="mdi mdi-delete font-weight-bold"></i></button>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button" class="btn btn-danger" id="sa-warning"><i
                                                        class="mdi mdi-delete font-weight-bold"></i>
                                                </button>
                                            </td>
                                        </tr>
                                    </tbody>
